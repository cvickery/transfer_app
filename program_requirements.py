...
class Requirements:
    ...
    def __init__(
        ...
        self.years = list(
            range(self.catalogs.first_academic_year.year, self.catalogs.last_academic_year.year + 1)
        )
        ...
        for line in lines:
            if (
                line.startswith("#")
                or line.startswith("/")
                or line.lower().startswith("log")
                or line.lower().startswith("remark")
            ):
    ...
    def __init__(self, century_1=None, year_1=None, century_2=None, year_2=None):
        ...
        if century_1 is None:
            ...
            if (100 * self.century_1 + self.year_1 + 1) != (100 * self.century_2 + self.year_2):
                raise ValueError(
                    f"{100 * self.century_1 + self.year_1}, "
